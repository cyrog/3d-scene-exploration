import {
  ...
  watch
} from "./chunk-CEGWPPVF.js";
import "./chunk-KUDUHDHN.js";
import {
  fromStore
} from "./chunk-2UR2FV2Q.js";
import "./chunk-TXKVZJ3K.js";
import "./chunk-RIXFT5AQ.js";
import {
  Jt,
  Xt,
  Yt
} from "./chunk-FLH4FNB3.js";
...
import {
  ...
  wrap_snippet,
  writable
} from "./chunk-Q45KAO4G.js";
import "./chunk-U7P2NEEE.js";
import {
  append,
  comment,
  template
} from "./chunk-OHOWWGAU.js";
import {
  ADD_OWNER,
  FILENAME,
  HMR,
  ...
  user_effect,
  user_pre_effect
} from "./chunk-IQJEKRY2.js";
import "./chunk-X4XZK27Q.js";
import "./chunk-RVAV4ZRS.js";
import {
  Sky
} from "./chunk-K3AMO7KW.js";
import {
  CSM
} from "./chunk-FFA653MS.js";
import {
  MeshBVH,
  ...
  shaderStructs
} from "./chunk-TWUL2OFP.js";
import {
  TextGeometry
} from "./chunk-PDU3LCRS.js";
import {
  FontLoader
} from "./chunk-RYS27L6M.js";
import {
  ThreePerf
} from "./chunk-4VWY7W6S.js";
import {
  AsciiEffect
} from "./chunk-2EVRSQRA.js";
import {
  Text,
  preloadFont
} from "./chunk-HA6EAHGJ.js";
...
} from "./chunk-SVZ4S6TW.js";
import {
  EXRLoader
} from "./chunk-RTHUZ53K.js";
import {
  RGBELoader
} from "./chunk-7ONIMWGA.js";
import {
  GroundedSkybox
} from "./chunk-F2FCQ56P.js";
import {
  TransformControls
} from "./chunk-6XCIGCFH.js";
import {
  GLTFLoader
} from "./chunk-TYJPQCJZ.js";
import {
  toCreasedNormals
} from "./chunk-ZAYUXT5D.js";
import {
  DRACOLoader
} from "./chunk-XAUBCJG6.js";
import {
  MeshoptDecoder
} from "./chunk-BXCRL7WE.js";
import {
  KTX2Loader
} from "./chunk-OAJ37QUJ.js";
import {
  Re
} from "./chunk-OARWTVTJ.js";
import {
  OrbitControls
} from "./chunk-M6ROKM5K.js";
import {
  TrackballControls
} from "./chunk-KVIE3GF4.js";
import {
  AdditiveBlending,
  AlwaysStencilFunc,
  AnimationMixer,
...
function Gizmo($$anchor, $$props) {
  ...
  user_effect(() => {
    const handleStart = (event) => {
      ...
      (_a2 = $$props.onstart) == null ? void 0 : _a2.call($$props, event);
    };
  ...
  user_effect(() => {
    const handleEnd = (event) => {
      ...
      (_a2 = $$props.onend) == null ? void 0 : _a2.call($$props, event);
    };
...
function CubeEnvironment($$anchor, $$props) {
  ...
  const first = derived(() => {
    var _a;
    return (_a = $$props.urls) == null ? void 0 : _a[0];
  });
  const firstIsHDR = derived(() => {
    var _a;
    return ((_a = get(first)) == null ? void 0 : _a.endsWith("hdr")) ?? false;
  });
...
function Environment($$anchor, $$props) {
  ...
  const isEXR = derived(() => {
    var _a;
    return ((_a = $$props.url) == null ? void 0 : _a.endsWith("exr")) ?? false;
  });
  const isHDR = derived(() => {
    var _a;
    return ((_a = $$props.url) == null ? void 0 : _a.endsWith("hdr")) ?? false;
  });
  const loader = derived(() => {
...
function VirtualEnvironment($$anchor, $$props) {
  ...
  const { start, stop, started } = useTask(
    () => {
      ...
      if (count < frames()) {
        ...
        stop();
        (_a = $$props.onupdatestop) == null ? void 0 : _a.call($$props);
      }
    },
    { autoStart: false }
  );
  const restart = () => {
    ...
    count = 0;
    start();
    (_b = $$props.onupdatestart) == null ? void 0 : _b.call($$props);
  };
  observe(
    () => [
      far(),
...
function AsciiRenderer($$anchor, $$props) {
  ...
  const stop = () => {
    var _a;
    stopRendering();
    (_a = $$props.onstop) == null ? void 0 : _a.call($$props);
  };
  user_effect(() => {
    if (autoRender()) {
      start();
  ...
  injectPlugin("transitions", (args) => {
    ...
    el.dispatchEvent = (e) => {
      ...
      if (strict_equals(e.type, "introstart")) {
        (_b = (_a = args.props).onintrostart) == null ? void 0 : _b.call(_a);
        ...
        (_f = (_e = args.props).onintroend) == null ? void 0 : _f.call(_e);
      ...
      return (_node, _params, options) => {
        ...
        return {
          ...
          tick(...args2) {
            var _a;
            invalidate();
            (_a = t == null ? void 0 : t.tick) == null ? void 0 : _a.call(t, ...args2);
          }
        };
      };
    };
